...
import { runA5ssSplicingMap } from "@/lib/api"
...
export function A5ssSplicingMapTab() {
  ...
  async function handleRun() {
    ...
    setImageUrl(null)
    try {
      const url = await runA5ssSplicingMap({
    ...
    <div className="flex h-full">
      ...
      >
        ...
        <div className="border-b px-5 py-3.5">
          <p className="text-sm font-semibold tracking-tight">5&apos; Splicing Map</p>
          <p className="mt-0.5 text-xs text-muted-foreground">
            Peak density around alternative 5&apos; splice-site events
          </p>
        </div>
        ...
        <div className="border-t px-5 py-4">
          ...
          >
            ...
            {loading ? "Running…" : "Run 5' Splicing Map"}
          </Button>
        </div>
      </form>
